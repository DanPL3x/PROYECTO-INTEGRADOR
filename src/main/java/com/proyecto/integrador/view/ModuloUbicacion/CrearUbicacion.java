...
public class CrearUbicacion extends JFrame {
    ...
    public void contenido1() {
        ...
        etiqueta1 = new JLabel("Bienvenido al Módulo de crear ubicación", SwingConstants.CENTER);
    ...
    public void contenido3() {
        ...
        crearUbi = new JButton("Crear");
        crearUbi.setFont(BtFont);
    ...
    public void ListenerCrearUbi(ActionListener parActionListener) {
        crearUbi.addActionListener(parActionListener);
        crearUbi.setActionCommand("CrearUbi");
    }
}
