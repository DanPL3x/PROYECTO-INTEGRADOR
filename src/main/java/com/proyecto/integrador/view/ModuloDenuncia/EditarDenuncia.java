...
public class EditarDenuncia extends JFrame {
    ...
    public void contenido1() {
        ...
        etiqueta1 = new JLabel("Bienvenido al Módulo de editar denuncia", SwingConstants.CENTER);
    ...
    public void contenido2() {
        ...
        jlidDen = new JLabel("Id de la denuncia a editar:*", SwingConstants.CENTER);
    ...
    public void contenido3() {
        ...
        editarDen = new JButton("Editar");
        editarDen.setFont(BtFont);

        panel3.add(editarDen);
    ...
    public void ListenerEditarDen(ActionListener parActionListener) {
        editarDen.addActionListener(parActionListener);
        editarDen.setActionCommand("EditarDen");
    }
}
