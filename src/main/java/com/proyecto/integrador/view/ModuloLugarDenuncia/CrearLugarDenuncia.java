...
public class CrearLugarDenuncia extends JFrame {
    ...
    public void contenido2() {
        ...
        jlidLugDen = new JLabel("Id del Lugar a crear:*", SwingConstants.CENTER);
    ...
    public void contenido3() {
        ...
        crearLugDen = new JButton("Crear");
        crearLugDen.setFont(BtFont);

        panel3.add(crearLugDen);
    ...
    public void ListenerCrearLugDen(ActionListener parActionListener) {
        crearLugDen.addActionListener(parActionListener);
        crearLugDen.setActionCommand("CrearLugDen");
    }
}
